...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/dashboard", { state: { defaultTab: ROLE_DEFAULT_TAB[data.user.role] || 'Dashboard' } });
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex bg-white font-sans">
      ...
      {/* Right panel */}
      <div className="w-full lg:w-2/5 flex flex-col items-center justify-center px-8 sm:px-12">
        {/* Card */}
        <div className="w-full max-w-md bg-white border border-gray-100 rounded-2xl shadow-lg p-8">
          {/* Card Header */}
          <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-100">
            <img src="/src/assets/brand_logo.png" alt="Brand Logo" className="h-16 w-16 object-contain flex-shrink-0" />
            <div>
              <h1 className="text-xl font-bold text-gray-800 leading-tight">Welcome back</h1>
        ...
        <form onSubmit={handleSubmit} noValidate autoComplete="off">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-4 py-2.5 rounded-xl border text-sm outline-none transition focus:ring-2 focus:ring-indigo-400 ${
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2.5 pr-11 rounded-xl border text-sm outline-none transition focus:ring-2 focus:ring-indigo-400 ${
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-indigo-500 transition cursor-pointer"
              >
                {showPassword ? (
          ...
          <div className="text-right mb-6">
            <Link to="/forgot-password" className="text-xs text-indigo-500 hover:text-indigo-700 hover:underline font-medium transition">
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            ...
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2.5 rounded-xl transition text-sm cursor-pointer disabled:opacity-60"
          >
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link to="/signup" className="text-indigo-600 font-semibold hover:underline transition">Sign Up</Link>
          </p>
        </div>
      </div>
    </div>
